...
type RecruiterTier = 'free' | 'paid' | 'corporate';
...
const RECRUITER_PLANS: RecruiterPlan[] = [
  {
    tier: 'free',
    name: 'Free',
    nameAr: 'مجاني',
    tagline: 'Basic Recruiter',
    taglineAr: 'حساب أساسي',
    badge: null,
    badgeIcon: null,
    features: [
      { label: 'Dashboard', included: true },
      { label: 'Publish Jobs', included: true },
      { label: 'Manage Jobs', included: true },
      { label: 'Applications', included: true },
      { label: 'AI Filter', included: false },
      { label: 'CV Directory', included: false },
      { label: 'Quiz', included: false },
      { label: 'Oral Presentation', included: false },
      { label: 'Preselection', included: false },
    ],
    cta: 'Explore Free',
    ctaAr: 'جرب المجاني',
    accent: {
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Manage Jobs', included: true },
      { label: 'Applications', included: true },
      { label: 'AI Filter', included: true },
      { label: 'CV Directory', included: true },
      { label: 'Quiz', included: false },
      { label: 'Oral Presentation', included: false },
      { label: 'Preselection', included: false },
    ],
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Oral Presentation', included: true },
      { label: 'Preselection', included: true },
    ],
        ...
        {isLoginOpen && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
            ...
            <motion.div 
              ...
              className={`bg-white w-full rounded-[2.5rem] shadow-2xl relative z-10 overflow-hidden border border-white/20 ${showRecruiterPlans ? 'max-w-2xl' : 'max-w-sm'}`}
            >
