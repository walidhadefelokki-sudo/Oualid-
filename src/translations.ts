export const translations = {
  fr: {
    ...
    applicationsCount: "Vous avez envoyé {count} candidature(s).",
    savedOffersCount: "{count} offre(s) d'emploi enregistrée(s).",
    alertsCount: "{count} notification(s) non lue(s).",
  ...
  ar: {
    ...
    applicationsCount: "لقد أرسلت {count} ترشيح.",
    savedOffersCount: "{count} عرض عمل محفوظ.",
    alertsCount: "{count} إشعار غير مقروء.",
